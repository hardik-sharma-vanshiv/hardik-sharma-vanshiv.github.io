        ...
        <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
            <div className="flex flex-row shrink-0 justify-center items-center gap-2">
                ...
                <Container className="h-24 w-24 circle-2">
                    <GoCopilot className="h-12 w-12 dark:text-black" />
                </Container>
                <Container className="h-32 w-32 circle-3">
                    <OpenAILogo className="h-16 w-16 dark:text-black" />
                </Container>
            ...
            <div className="h-40 w-px absolute top-6 m-auto z-40 bg-gradient-to-b from-black via-cyan-500 to-black animate-move">
