...
export default function Footer() {
  return (
    <footer id="contact" className="bg-[#111111] text-white pt-20 pb-10 w-full relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <FadeIn direction="up" delay={400} className="mt-10 pt-6 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4 text-gray-500 text-xs">
          <p>© {new Date().getFullYear()} Vanshiv. All rights reserved.</p>
